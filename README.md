...
- **Dynamic Date & Timezones**: Automatically positioned date, timezone, Chinese Lunar Date, and **Moon Phase** display.
    - **Moon Phase**: Real-time lunar phase with emoji in the date line and a photo of the current moon (8 phases, pure JS calculation). Toggleable.
    - **Decoupled Visibility**: Toggle each element (Date, Lunar, Moon Phase, TZ) independently.
...
- YouTube IFrame API.
- Web Audio API (alarm sounds, Relax Time ambient synthesis).
